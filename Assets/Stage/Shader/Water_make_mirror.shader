Shader "Custom/Water_make_mirror" {
	Properties{
		...
		_Displane("Displace",Vector) = (0,0,0,0)
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			half2 grabUV = (IN.screenPos.xy / (IN.screenPos.w+0.0000001))*float2(1, -1) + float2(0, 1);
